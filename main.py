...
class GerenciadorTarefas:
    def __init__(self):
        ...
        self.tabela_global.heading("RAM Total", text="total_ram")
        self.tabela_global.heading("RAM Livre", text="free_ram")
        self.tabela_global.heading("Porcentagem de RAM utilizada", text="ram_usage_percentage")
        self.tabela_global.heading("Swap Total", text="total_swap")
        self.tabela_global.heading("Swap Livre", text="free_swap")
        self.tabela_global.heading("Porcentagem de Swap utilizado", text="swap_usage_percentage")
